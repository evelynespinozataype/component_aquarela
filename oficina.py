...
class Oficina:
    ...
    __mapa_int = {'01':1,'02':2,'03':3,'04':4,'05':5,'06':6}
    ...
    __foto = None
    __proxima = []
    __lista_fisico_aquarela = {}
    __lista_fisico_emocao = {}
    __is_open = True 
    ...
    def adicionar_fisico_emocao(self,key,obj):
        self.__lista_fisico_emocao[key] = obj
    ...
    def get_todos_fisico_emocao(self):
        return self.__lista_fisico_emocao

    def adicionar_fisico_aquarela(self,key,obj):
        self.__lista_fisico_aquarela[key] = obj

    def get_todos_fisico_aquarela(self):
        return self.__lista_fisico_aquarela

    def get_one_fisico(self,key):
        if id in self.__lista_fisico_emocao:
           return self.__lista_fisico_emocao[key]
        if id in self.__lista_fisico_aquarela:
           return self.__lista_fisico_aquarela[key]
        return None

    def get_todo_fisico(self):
        lista_fisico = self.__lista_fisico_aquarela
        for key in self.__lista_fisico_emocao:
            lista_fisico =  self.__lista_fisico_emocao[key]
        return lista_fisico

    def retirar_todos_fisicos(self):
        self.__lista_fisico_aquarela = {}
        self.__lista_fisico_emocao = {}
    ...
    def get_participantes(self):
        return self.__participantes_online
    ...
    def get_objeto_int(self,qrc):
        return self.__mapa_int[qrc]
    ...
    def gravar_log(self,participante,interface,acao,objeto):
        if participante['id'] == None:
            participante = {'id':'', 'nome': '', 'local':'','coisa':'','url_avatar': ''}
